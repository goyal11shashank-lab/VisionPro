...
export const PrimaryItemsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bulk Delete Modal */}
      {showBulkDeleteModal && (
        <div id="modal-bulk-delete-primary-items" className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 max-h-36 overflow-y-auto bg-slate-50 p-2.5 rounded-lg border border-slate-200 text-xs space-y-1">
                  {selectedPrimaryItems.slice(0, 10).map(i => (
                  ...
                  {selectedPrimaryItems.length > 10 && (
                    <p className="text-slate-400 italic pt-1 text-center">
                      ...and {selectedPrimaryItems.length - 10} more
                    </p>
                  )}
                </div>
